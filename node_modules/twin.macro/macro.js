...
var validImports = new Set(['default', 'styled', 'css', 'theme', 'TwStyle', 'ThemeStyle']);
...
var getComponentRules = function (rules, screens) { return rules.reduce(function (result, rule) {
  var obj;

  // Rule is a media query
  if (rule.type === 'atrule') {
    var atSelector = buildAtSelector(rule.name, rule.params, screens);
    return deepMerge(result, ( obj = {}, obj[atSelector] = getComponentRules(rule.nodes, screens), obj ));
  }
...
var getUserPluginData = function (ref) {
  ...
  var components = getComponentRules(processedPlugins.components, config.theme.screens);
  /**
   * Utilities
...
var twinMacro = function (ref) {
  ...
  isDev && Boolean(config.debugPlugins) && debugPlugins(state.userPluginData); // Styled import
